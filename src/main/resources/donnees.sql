...
VALUES
  ('L’Énigme du Temps', 'Claire Dumas', 'Un roman captivant mêlant science-fiction et philosophie.', NULL, 14),
...
INSERT INTO exemplaires (livre_profil_id, statut)
VALUES
  -- exemplaires pour "L’Énigme du Temps"
  (1, 'disponible'),
  (1, 'emprunte'),
